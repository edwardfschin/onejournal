...
| Rows and identifiers used to track activity | Continuity from source event to trade history | Stable normalized-fill identity, deterministic replay/conflict handling, calculation-input fingerprints, and lifecycle events | ADR-0005 and accepted ADR-0006; roadmap CON-05 and JRN-01 through JRN-07 |
| Corrected rows and replaced workbook copies | Preserve why evidence changed and which results must be reconsidered | Future immutable evidence versions, explicit supersession, governed corrections, invalidation, recalculation, and raw-to-output lineage | Proposed ADR-0010; roadmap CON-07 and JRN-08; currently M0 with partial prototype mechanisms |
...
| Workbook snapshots and saved copies | Retain historical context and support comparison over time | As-of-aware canonical state, append-only journal history, versioned calculations, and reproducible reports; complete evidence supersession remains proposed | ADR-0003, ADR-0006, ADR-0008, and proposed ADR-0010; roadmap JRN-06, JRN-08, and PNL-04 through PNL-07 |
