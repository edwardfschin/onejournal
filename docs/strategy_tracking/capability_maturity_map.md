...
Snapshot date: 2026-08-31. This summary is derived from the current product
...
| Market quotes and freshness | M4 - Operationally accepted for the bounded owner-operated local Schwab bridge scope | Accepted 2026-08-31 for manual credential-free bridge intake, OneJournal-owned conversion/session/freshness, private materialization, and isolated DuckDB persistence/read-back | No continuous acquisition, public/hosted service, production journal migration, OneJournal credential ownership, IBKR/Moomoo adapter, or PNL-03 valuation mark is accepted. T15 cutover remains later target-architecture work | PNL-02 |
| Positions, portfolio valuation, performance, and reports | M1 - Defined, with partial groundwork | Not accepted | PNL-03T privately validates durable complete binding plus eligible-46 FIFO and exact broker reconciliation while preserving seven unavailable positions; valuation marks, persistence, API/presentation behavior, complete totals, canonical unrealized P&L integration, and owner financial acceptance remain open | PNL-03 through PNL-08 |
...
| Production website | M3 - Validated for the local synthetic-fixture scope | Not accepted | ADR-0017 accepts the open-source React/TypeScript/Vite/FastAPI foundation and visible delivery WBS; ADR-0018 defines the finite 12-item Phase 1 Private Owner Release. The synthetic React/Vite preview and loopback-only versioned FastAPI fixture boundary pass their local build, contract, clean-CI, and HTTP checks. Authentication, real data, hosted runtime, deployment, and production validation remain outstanding | P1-01 through P1-12, WEB-01 through WEB-09, and WEB-W01 through WEB-W13 |
