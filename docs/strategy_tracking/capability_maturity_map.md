...
| Production website | M1 - Defined | Not accepted | ADR-0017 accepts the open-source React/TypeScript/Vite/FastAPI foundation and visible delivery WBS; ADR-0018 defines the finite 12-item Phase 1 Private Owner Release. No frontend/API implementation, approved rendered design system, authentication, hosted runtime, deployment, or production validation exists | P1-01 through P1-12, WEB-01 through WEB-09, and WEB-W01 through WEB-W13 |
