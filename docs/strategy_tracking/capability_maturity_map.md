...
| Positions, portfolio valuation, performance, and reports | M1 - Defined, with partial groundwork | Not accepted | PNL-02's bounded quote boundary is accepted, but PNL-03 must still approve and prove cumulative broker-position authority/reconciliation, mark selection, spread/instrument handling, canonical P&L integration, and fail-closed unavailable states before valuation | PNL-03 through PNL-08 |
