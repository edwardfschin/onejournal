...
| Production website | M2 - Implemented | Not accepted | ADR-0017 accepts the open-source React/TypeScript/Vite/FastAPI foundation and visible delivery WBS; ADR-0018 defines the finite 12-item Phase 1 Private Owner Release. The synthetic React/Vite frontend preview is implemented and locally validated; API boundary, authentication, hosted runtime, deployment, and production validation remain outstanding | P1-01 through P1-12, WEB-01 through WEB-09, and WEB-W01 through WEB-W13 |
