...
| Realized P&L | M2 - Implemented with focused contract evidence | Not accepted | ADR-0003 policy is accepted; manual review of real Schwab lifecycle evidence, broker-result reconciliation, and owner sign-off remain open | PNL-01 |
