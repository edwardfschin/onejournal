...
| P1-08 | IN PROGRESS | Deliver the bounded Phase 1 current portfolio, account/symbol breakdown, date-filtered P&L history, CSV export, and complete quality states for displayed metrics. | Gate 0 established that migration-0023 operational state has the accepted WEB-W07 current valuation but zero realized-P&L runs or allocations and no safe account label. Gate 1 was owner-approved on 2026-09-07: accepted ADR-0029 and the Phase 1 reporting release contract now define the required bounded authority, reconciliation, alias, quality, export-parity, and separate approval gates. Gate 2 implementation and every later private, persistence, verification, acceptance, and Git gate remain open. Advanced returns, drawdown, exposure, portfolio-history series, and broader analytics remain later. |
...
| WEB-W08 | IN PROGRESS | Gate 0 verified the accepted current-valuation source and the absence of operational realized-P&L authority. Gate 1 was owner-approved on 2026-09-07: accepted ADR-0029 and `docs/phase1_reporting_release_contract.md` define the bounded account/symbol, realized-history, export-parity, privacy, and ADR-0007 quality boundary. Gate 2 implementation and all later persistence, verification, acceptance, and Git gates remain open. |
