...
| CON-03 | NEXT | Define realized P&L, unrealized P&L, cost basis, tax-lot policy, fees, commissions, and return calculations. | Approved P&L contract with worked examples that reconcile exactly. |
