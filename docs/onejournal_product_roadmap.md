...
- PNL-02: the project owner approved Schwab first, IBKR next, and Moomoo later,
  ...
  remaining PNL-02 work is provider-native adapter evidence, an approved
  durable ingestion operator/runtime migration, broader provider/asset
  validation, single-owner cutover, and end-to-end adapter validation. The
