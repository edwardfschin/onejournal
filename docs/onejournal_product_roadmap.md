...
Phase 1 progress: **6 of 12 work packages complete**.
...
| P1-06 | COMPLETE | Deliver the private local-owner trade and journal vertical slice through the new application boundary. | Completed and owner-accepted on 2026-09-07 for the current local release scope. WEB-W06 uses a loopback-only FastAPI boundary and a server-selected `0600` local-owner DuckDB with no Streamlit or provider call. The operational journal is at migration 0021 with clean read-only integrity and an active 267-lifecycle/539-execution history revision; the prior 217-lifecycle/430-execution revision remains append-only rollback evidence. ADR-0025 preserves terminal-event and complete-current-position reconciliation, ADR-0026 preserves 63 privacy-safe vertical presentation pairs, and ADR-0027 preserves source-derived phases, exact option-to-stock links, and reason-coded expiration stories without promoting review-required outcomes. Reviews and journal entries remain append-only, linked stock cards are presentation-de-duplicated without merging records, ambiguous relationships fail closed, provider identities remain private, and no P&L authority is introduced. The owner accepts the current local journal experience for this release scope; further visual refinement remains enhancement backlog and does not reopen P1-06. |
| P1-07 | COMPLETE | Approve and deliver canonical current positions, cost basis, marks, market value, and unrealized P&L. | Completed and owner-accepted on 2026-09-07 for the demonstrated private single-owner local-only WEB-W07 scope. The exact accepted broker-current result is persisted in the mode-`0600` operational journal through migration 0023 as one run, 58 position snapshots, 58 valuations, and one complete-total row. The loopback API and canonical `/local/portfolio` route preserve explicit as-of, source/run/snapshot/fingerprint/acceptance lineage, currency quantum, 58/58/58 independent metric availability, and complete-total gates. Desktop, tablet, and mobile browser checks passed without horizontal overflow; an unavailable API produced the explicit fail-closed UI with no cached, synthetic, or historical FIFO substitution. Exactly one value-free accepted-read audit row was written. The mode-first URL correction, all 525 tests, the frontend production build, focused frontend lint, private authorization checks, journal integrity, and automatic-trading-disabled checks passed. This acceptance does not include continuous provider acquisition, credential ownership, authentication, hosting, VPS work, deployment, broader or realized P&L, or trading. No commit or push is included. |
| P1-08 | IN PROGRESS | Deliver the bounded Phase 1 current portfolio, account/symbol breakdown, date-filtered P&L history, CSV export, and complete quality states for displayed metrics. | Gate 0 established that migration-0023 operational state had the accepted WEB-W07 current valuation but zero realized-P&L runs or allocations and no safe account label. Gate 1 was owner-approved on 2026-09-07. The original Gate 2 implementation was merged on 2026-09-08, and migration 0024 was later separately backed up, rehearsed, and applied with all new tables empty. A first Gate 3 calculation exposed the missing active-history calculation operator and was not accepted. The Gate 2 precision correction now adds a read-only deterministic calculation, exact revision/count/execution reconciliation, explicit unresolved-scope omissions, tamper-evident result acceptance, and process-start report-authorization loading. All 546 tests plus 267 subtests, focused checks, frontend lint, and the production build pass locally. Corrected read-only Gate 3 replay produced exact fingerprint `bd05ac8f87e58b9fdc57792cd19f763ee40a136dcd692e8e0399d19227566063`, with 230 admitted allocations and 57 withheld scopes across the 2026-03-06 through 2026-09-04 coverage window. Mapping, value-sum, omission/reason, date, integrity, deterministic replay, and unchanged-database checks pass. The owner explicitly accepted that exact incomplete bounded result on 2026-09-09 under `ONEJOURNAL-WEB-W08-GATE3-OWNER-ACCEPTANCE-20260909-01`; Gate 3 is complete. Migration 0025 now preserves separate current-result and realized-result acceptance identities and times. After successful disposable-copy rehearsal, the separately approved fresh backup and live migration reached 0025 with all 81 compared data-table row counts unchanged, integrity clean, and all five reporting tables empty. Accepted-result persistence, private API/browser verification, release owner acceptance, commit, and push remain open. Advanced returns, drawdown, exposure, portfolio-history series, and broader analytics remain later. |
...
| PNL-03 | COMPLETE | Implement current positions, cost basis, market value, and unrealized P&L. | PNL-03A through X preserve the historical fail-closed FIFO route and introduce the separately labelled ADR-0023 broker-reconciled current-position view. Owner-private replacement package `PNL-03X-BROKER-CURRENT-20260905-02` uses direct checksum-bound Schwab v3 position evidence, retains the exact currency quantum, and independently makes cost basis, market value, and unrealized P&L available for all 58 current positions; its calculation reconciles every position to Schwab open P&L. Separate package `PNL-03X-BROKER-CURRENT-ACCEPTANCE-20260905-01` records explicit owner acceptance of that exact run and result fingerprint. The exact accepted result was subsequently persisted in the private operational journal through migration 0023 and owner-accepted on 2026-09-07 through the local-only WEB-W07 API/application slice without changing FIFO or the historical `46/4/3` and `48/10` evidence. Completion remains limited to the private single-owner broker-current scope: no continuous provider acquisition, credential ownership, authenticated hosted route, production deployment, Commercial API parity, or realized-P&L completion for transferred lots is claimed. No commit, push, or sync is included. |
| PNL-03G | COMPLETE | Define and implement the bounded credential-free Schwab position-evidence acquisition profile. | ADR-0020 is accepted. `schwab-read-only-single-account-positions.v1` permits exactly one privacy-preserving position GET envelope, binds only an account-hash digest in canonical metadata, and converts verified bytes in memory through the current `schwab-position-json-v2` adapter. Focused synthetic tests prove legacy-profile compatibility, endpoint/count restrictions, manifest privacy, tamper rejection, private account binding, exact mappings, and deterministic replay. No provider call, private evidence, database state, or operational acceptance existed at this task's completion. |
| PNL-03H | COMPLETE | Implement a guarded owner-only position intake validation operator and offline conformance tests. | `validate_external_schwab_position_acquisition.py` accepts only pre-existing `0700`/`0600` private inputs, validates the exact external position profile and private account/mapping binding through the credential-free adapter, and emits a secret-free digest/count audit. It cannot call a provider, use credentials, write evidence, materialize data, or write DuckDB. Offline tests prove permissions, canonical binding, profile/account/mapping/tamper rejection, output privacy, and no write-capability. Real capture, transfer, and private-binding creation remain separately approval-gated. |
| PNL-03I | COMPLETE | Acquire one bounded owner-private Schwab account binding and complete position response at the OneBot token-owner boundary. | Approved run `PNL-03I-SCHWAB-20260831-01` completed one account-number mapping GET and one single-account positions GET with zero refreshes, retries, redirects, order, transaction, or database activity. Source-host validation proved canonical manifest-last evidence, exact hashes, owner-only permissions, unchanged token-file timestamp during capture, and omission of raw account identifiers from the acquisition manifest. At this task's completion the bundle remained only on the private source host; its later transfer and coverage audit are recorded by PNL-03K. |
| PNL-03J | COMPLETE | Correct the credential-free Schwab position adapter for the bounded real provider shape. | `schwab-position-json-v2` requires strict 21-character OCC verification against every explicit option identity term and accepts Schwab `COLLECTIVE_INVESTMENT` as canonical equity only for exact subtype `EXCHANGE_TRADED_FUND`. All other collective types, malformed symbols, mismatched mappings, and conflicting optional fields fail closed. Twenty focused contract/register tests and the full 387-test offline CI pass; no provider, credential, private-evidence, database, or deployment action occurred in this correction. |
| PNL-03K | COMPLETE | Transfer the PNL-03I bundle and audit existing accepted lifecycle coverage against the current position snapshot. | The seven-file bundle was copied checksum-preservingly to the local OneJournal private evidence root with exact VPS hash parity, `0700`/`0600`, no overwrite, and credential-free acquisition validation. The complete snapshot contains 53 unique current identities (47 options and six equities/ETFs). Five accepted PNL-01 scopes contain seven unique historical identities; exact current overlap is zero. No private binding, default currency/multiplier, provider call, database write, repository change, or financial acceptance occurred. |
| PNL-03L | COMPLETE | Define and implement a bounded credential-free Schwab lifecycle-evidence acquisition profile. | Accepted ADR-0021 adds `schwab-read-only-single-account-lifecycle.v1`: one exact paired order/transaction window of at most 30 days, shared private account-hash/date binding, strict GET/query/count and potential-truncation gates, canonical owner-private account binding, in-memory existing-adapter conversion, opaque-account substitution, privacy-safe exact-identity reconciliation, and a validation-only operator. Focused tests prove deterministic replay, legacy profile compatibility, permissions, privacy, empty windows, account/window/tamper/truncation rejection, and no provider/credential/database/write capability. No real provider call, private binding/evidence write, database action, commit, push, sync, or deployment is authorized or claimed. |
| PNL-03M | COMPLETE | Capture, transfer, and validate the first bounded real Schwab lifecycle window, then correct observed currency provenance at the source boundary. | Approved run `PNL-03M-SCHWAB-20260901-01` used the existing unexpired OneBot VPS token for exactly one orders GET and one transactions GET covering 2026-08-03 through 2026-09-01, with zero refreshes, retries, redirects, account/position calls, request bodies, or database writes. The six-file manifest-last bundle contains 151 orders and 71 transactions and was transferred with exact SHA-256 parity and `0700`/`0600` permissions. Credential-free replay found 296 explicit `CURRENCY_USD` legs on eligible valid trades and no conflicting eligible code; one equity trade lacking its own currency leg is therefore resolved by recorded same-account/window provider consensus, never a Schwab default. The result has 59 order fills, 61 transaction fills, 59 exact matches, zero order-only rows, two transaction-only rows, and three lifecycle events/legs. Reconciliation remains pending; nothing was materialized, persisted, presented as P&L, committed, pushed, synced, or deployed. |
| PNL-03N | COMPLETE | Implement deterministic cross-window lifecycle assembly and assess current-position fill coverage. | `onejournal.current-position-lifecycle-coverage.v1` requires one exact provider/connection/account, contiguous non-overlapping windows, stable-identity deduplication with conflict rejection, snapshot-time cutoff, cross-window order/transaction reconciliation, transaction-authoritative canonical identity, and explicit history-extension/review states. Eight focused synthetic tests cover cross-window fills, replay/conflict, gap/overlap/scope, missing order IDs, lifecycle review, post-snapshot exclusion, option identity conflict, and privacy; the full 406-test offline CI passes. Credential-free replay of the existing real snapshot/window produced assembly `154254ce4a8e91931fb4463f07e7e15141fa21ff2d72c5a09455ec8bb5c4aaf8` across 53 positions: 25 `fill_flat_start_proven`, 27 `history_extension_required`, and one `review_required` because its Schwab transaction has no order ID. This is unmaterialized coverage only; no provider call, credential access, private write, database action, accepted FIFO/valuation, commit, push, sync, or deployment occurred. |
| PNL-03O | COMPLETE | Extend real lifecycle coverage and correct Schwab window-membership semantics at the source boundary. | Approved run `PNL-03O-SCHWAB-20260901-01` captured the contiguous 2026-07-04 through 2026-08-02 window using exactly one approved refresh, one orders GET, and one transactions GET, then transferred the immutable six-file bundle with exact checksum parity and owner-only permissions. Real-shape review proved that top-level order entry time is insufficient: pre-window orders can close or execute inside the requested period, while a provider-returned transaction can carry an adjacent-date canonical lifecycle event. The corrected credential-free boundary accepts order records by entry, close, or recursive execution intersection; admits fills only by exact execution time and events/legs only by exact event time; exposes every exclusion count; and leaves raw bytes unchanged. Replay produced 91 order fills, 91 transaction fills, 91 exact matches, five lifecycle events/legs, and one explicitly excluded adjacent-date event/leg. Two-window assembly `0f232139bff6d97064c07cc7b81695bd31a91938885e9d545b34b4d4d389d3a8` has 150 order fills, 152 transaction fills, 150 matches, two transaction-only rows, and current-position states 42 `fill_flat_start_proven`, 10 `history_extension_required`, and one `review_required`; the full 408-test offline CI passes. No database write, materialization, accepted FIFO/valuation, commit, push, sync, or deployment occurred. |
| PNL-03P | COMPLETE | Extend lifecycle coverage through 2026-06-04 and correct repeated non-intersecting OCO record handling. | Approved run `PNL-03P-SCHWAB-20260901-01` used exactly one OAuth refresh, one single-account orders GET, and one single-account transactions GET for 2026-06-04 through 2026-07-03, producing 173 orders and 84 transactions. The manifest-last six-file bundle was transferred with exact VPS/local SHA-256 parity and `0700`/`0600` permissions. Two top-level OCO parents were exact raw replays from PNL-03O with no timestamp or fill in the PNL-03P window. The corrected source boundary validates every raw record, preserves but excludes and counts these two records before normalization, and continues failing closed for missing/malformed timestamps or account mismatch. PNL-03P replay has 70 order fills, 71 transaction fills, 70 matches, one transaction-only row, and two lifecycle events/legs. Three-window assembly `ac6786dcecc9daa10c6ac4e14f04dc2a8166a8f011ff5f85f51afa9633d06653` has 220 order fills, 223 transaction fills, 220 matches, three transaction-only rows, and current-position states 44 `fill_flat_start_proven`, eight `history_extension_required`, and one `review_required`; the full 408-test offline CI passes. No database write, materialization, accepted FIFO/valuation, commit, push, sync, or deployment occurred. |
| PNL-03Q | COMPLETE | Extend lifecycle coverage through 2026-05-05 and reassess current-position fill coverage. | Approved run `PNL-03Q-SCHWAB-20260901-01` used exactly one OAuth refresh because the existing token was expired, then exactly one single-account orders GET and one single-account transactions GET for 2026-05-05 through 2026-06-03, producing 196 orders and 138 transactions. The manifest-last six-file bundle was transferred with exact VPS/local SHA-256 parity and `0700`/`0600` permissions. Credential-free replay admitted 123 order fills and 123 transaction fills, matched 121, retained two order-only and two transaction-only rows, and retained one lifecycle event/leg; two valid non-intersecting top-level order records were preserved but excluded before normalization. Four-window assembly `3c80d8c3377a23777eab41dc14ed23ffcb38c38e521d92310e36586752e9415e` has 343 order fills, 346 transaction fills, 341 matches, two order-only rows, five transaction-only rows, four excluded raw order records, and current-position states 46 `fill_flat_start_proven`, five `history_extension_required`, and two `review_required`. The newly review-required position has no provider order ID and zero exact execution-signature order candidates; it remains fail-closed. Offline validation completed without database or repository writes. |
| PNL-03R | COMPLETE | Extend lifecycle coverage through 2026-04-05 and reassess current-position fill coverage. | Approved run `PNL-03R-SCHWAB-20260901-01` used exactly one OAuth refresh because the existing token was expired, then exactly one single-account orders GET and one single-account transactions GET for 2026-04-05 through 2026-05-04, producing 193 orders and 92 transactions. The manifest-last six-file bundle was transferred with exact VPS/local SHA-256 parity and `0700`/`0600` permissions. Credential-free replay admitted 72 order fills and 74 transaction fills, matched 72, retained no order-only and two transaction-only rows, and retained six lifecycle events/legs; two valid non-intersecting top-level order records were preserved but excluded before normalization. Five-window assembly `7454c4543439dd6fc49d3e2089ed326ebe6eac0a3cdf8a32a82765d19c041fe6` has 415 order fills, 420 transaction fills, 413 matches, two order-only rows, seven transaction-only rows, six excluded raw order records, and current-position states 46 `fill_flat_start_proven`, four `history_extension_required`, and three `review_required`. The newly review-required position has no provider order ID and zero exact execution-signature order candidates; it remains fail-closed. Offline validation completed without database or repository writes. |
| PNL-03S | COMPLETE | Approve the bounded fail-closed PNL-03 completion route. | Accepted ADR-0022 freezes five-window assembly `7454c4543439dd6fc49d3e2089ed326ebe6eac0a3cdf8a32a82765d19c041fe6` as the initial 46/4/3 coverage baseline. The 46 fill-flat-proven positions may proceed only through the remaining binding, FIFO, reconciliation, mark, persistence, API, and owner-acceptance gates. Four history-extension and three review-required positions remain members of the complete snapshot but financially unavailable and excluded from FIFO, valuation, P&L, and complete totals. Eligible results are labelled a subtotal, never the portfolio total. Future history extension is optional, additive, versioned evidence and no longer blocks the bounded route. No operational or financial acceptance is claimed. |
| PNL-03T | COMPLETE | Bind the frozen bounded scope to durable private identity evidence, eligible FIFO, and exact broker reconciliation. | Owner-private route `pnl-03t-replacement-2026-09-04.v2` uses one permanent opaque account scope and independently preserves the 53-position `46/4/3` assessment under replacement assembly `8e88ab2f3db3555b6b111e45b0308e2029748187258cccbdbcb7156a8ce892a0`; frozen historical assembly `7454c4543439dd6fc49d3e2089ed326ebe6eac0a3cdf8a32a82765d19c041fe6` remains unchanged. Fifty mappings are transaction-authoritative, two unresolved equities use complete-position asset identity plus the accepted same-account transaction currency consensus, and one unresolved option adds exact private Schwab chain multiplier evidence from run `PNL-03T-I-SCHWAB-20260904-02`. That run used the OneBot VPS active-producer token for exactly one OAuth refresh and one bounded option-chain GET, with no retry, redirect, account/order/transaction/position call, request body, database write, or order write. The raw response was preserved before a Decimal-only evidence-serialization failure; a manifest-recorded offline finalizer made zero additional provider or credential calls and proved an exact standard, non-mini contract match. Durable complete position binding `5eefa7ec4c059d2b78db3f7f968407b711dbde63a1a04e749b598f426ee00295` and eligible fill fingerprint `1465070d22c6c2e07e22d28a81bebdd250c2aa5607bb20eb3ff3c5c1b28eb4a1` replay deterministically: all 46 eligible positions pass FIFO and exact broker-quantity reconciliation, zero remain reconciliation-pending, and all seven unresolved positions remain present and financially unavailable. The only available aggregate is labelled an eligible subtotal, never a portfolio total. No valuation mark, journal/database persistence, API/presentation enablement, complete portfolio total, owner financial acceptance, commit, push, sync, or deployment is claimed. |
| PNL-03U | COMPLETE | Preserve the 53-position result and version the later 58-position private binding/FIFO assessment. | A privacy-safe delta audit recorded ten additions and five removals without exposing identities or values. The permanent opaque account scope and complete 58-position binding `0e1000853e056a5a6079494f6b92c2d8eb802ad562476de8025ef0a5c2e7894d` are stored privately with `0700`/`0600` permissions. Versioned route `pnl-03u-58-position-2026-09-04.v3` produced assembly `19641dfff25dd568147148defa33b8e900d132a13f8e1fc4d4b12e7b829590d4`: 48 positions passed FIFO and exact broker reconciliation, six required history extension, four required review, and zero were reconciliation-pending. The historical 53-position `46/4/3` result remains immutable. Only eligible cost basis is available as a subtotal; all ten unresolved positions and complete totals remain unavailable. No database persistence, API release, financial acceptance, commit, push, sync, or deployment is claimed. |
| PNL-03V | COMPLETE | Refresh the bounded 58-position evidence and prove the eligible-48 valuation gate. | Approved append-only captures produced a complete 58-position snapshot, a replacement September 2-4 lifecycle window, one exact 48-symbol quote batch, and one September 4 Schwab market-hours response. One separately approved OneBot-owned pre-capture refresh restored the existing token lifecycle; the successful runs then used three position/lifecycle provider GETs and two market-data GETs in total, with zero in-capture refreshes, retries, redirects, database writes, or order writes. Source and MacBook-vault checksums match and all private material remains `0700`/`0600`. Replacement route `pnl-03v-58-position-2026-09-04.v4` independently preserved the durable binding and exact `48/6/4` coverage under assembly `6e3787b92892fba4c536c5bd88dfcc57b22e985f8ee80e5663629cac6202115f`; all 48 eligible positions pass FIFO and broker reconciliation with zero pending. Capture occurred after the 16:00 New York option close, so same-provider authority classified all 48 real-time quotes as `market_closed_last`; exact last marks made eligible market-value and unrealized-P&L subtotals available with zero mark failures. Ten positions remain financially unavailable and no portfolio total exists. Private package `PNL-03V-VALUATION-GATE-20260904-01` replays deterministically and retains `financial_acceptance=false`; no journal persistence, API/presentation release, commit, push, sync, or deployment is claimed. |
| PNL-03W | COMPLETE | Persist and serialize the bounded valuation without weakening unavailable or portfolio-total semantics. | Additive migration 0014 introduces separate bounded run, complete-position, and eligible-subtotal tables while preserving generic migration 0013. The guarded repository requires an existing migrated database, validates exact complete-snapshot identity and quantity scope, writes transactionally, rejects conflicting replay, and reads one explicit run. The unregistered `onejournal.api.pnl03-position-valuation.v1` serializer withholds values without a matching run UID and result fingerprint in `onejournal.pnl03-financial-release-authorization.v1`, rejects mismatched authorization, retains all 58 current-shape positions, leaves ten unavailable positions null, emits decimal strings for the eligible 48 only after authorization, and always returns null portfolio totals. Append-only private package `PNL-03V-VALUATION-GATE-20260904-02` preserves `-01`, binds result fingerprint `81f058147783b24d1cbedcea1ca0514ffa52b2468df7a42fdad5e68fd7a8ee6d`, and proves exact create/read-back/replay in a disposable database. Tests use temporary DuckDB only; no actual journal migration, active route, authentication change, owner acceptance, commit, push, sync, or deployment is claimed. |
| PNL-03X | COMPLETE | Define and implement broker-reconciled current-position valuation without fabricating lot history. | Accepted ADR-0023 keeps OneJournal FIFO authoritative for realized P&L and lot-level analytics while adding `onejournal.broker-current-position-valuation.v1` for a separately labelled current broker view. `schwab-position-json-v3` preserves the direction-specific Schwab tax-lot average independently of generic average price. The pure validator uses signed quantity and explicit multiplier, reconciles calculated unrealized P&L to broker open P&L at an explicit currency quantum, gates cost basis/market value/unrealized P&L independently, and exposes complete totals only when every snapshot member has the applicable metric. Synthetic tests cover transferred equity, short options, missing basis, mismatches, freshness, scope, determinism, and privacy. Historical `46/4/3` and `48/10` results remain unchanged. No provider call, credential access, private write, database action, route activation, financial acceptance, commit, push, sync, or deployment is claimed. |
| PNL-03Y | COMPLETE | Persist, privately serialize, and accept the exact 58-position broker-current result. | Additive migration 0015 retains direction-specific broker aggregate basis and adds separate broker-current run, position, rounding-policy, availability, reconciliation, and complete-total tables. Migration 0023 widens only the proven broker-current decimal fields to preserve the accepted result without rounding. The guarded repository reconstructs the result from its snapshot before atomic append, accepts only identical replay, and reads one explicit run. The private response contract withholds values until a release authorization matches both run UID and result fingerprint. Replacement result `PNL-03X-BROKER-CURRENT-20260905-02` preserves `-01`, includes explicit USD quantum lineage, and reports 58/58/58 metric availability; separate package `PNL-03X-BROKER-CURRENT-ACCEPTANCE-20260905-01` accepts that exact result. After backup and disposable-copy rehearsal, migrations through 0023 and the exact result were applied to the private operational journal; one real loopback read wrote exactly one privacy-safe audit row, and the owner accepted the demonstrated WEB-W07 scope on 2026-09-07. Authentication, provider access, hosting, deployment, commit, push, and sync remain excluded. |
...
| WEB-07 | IN PROGRESS | Implement local-owner journal, portfolio, P&L, trade, report, data-health, and settings vertical slices. | WEB-W06 and WEB-W07 are owner-accepted for their bounded private local-only release scopes. WEB-W07's exact broker-current result is persisted through migration 0023 and its authorized loopback API/application path passed real desktop, tablet, mobile, unavailable-state, privacy-audit, and integrity verification. Later report, data-health, settings, and broader P&L slices remain open. |
...
| WEB-W06 | COMPLETE | Owner-accepted on 2026-09-07 for the current local release scope. The loopback-only v5 API/UI reads the server-selected `0600` operational journal at migration 0021 and exposes its active 267-lifecycle/539-execution revision while retaining the prior 217-lifecycle/430-execution revision as append-only rollback evidence. ADR-0026 preserves 63 privacy-safe vertical presentation pairs; ADR-0027 preserves exact opening/closing phases, unique option-to-stock settlement links, and reason-coded expiration stories without changing review or P&L authority. Linked stock cards are suppressed only as list duplicates, and exact stock lifecycles remain independently inspectable. The current experience is accepted for this release; further visual improvements remain enhancement backlog. |
| WEB-W07 | COMPLETE | Completed and owner-accepted on 2026-09-07 for the demonstrated private single-owner local-only scope. Following checksum-identical backup and disposable-copy rehearsal, migrations through 0023 and the exact accepted 58-position result were applied to the mode-`0600` operational journal. The authorized loopback route, now canonical at `/local/portfolio`, preserved exact as-of, source/run/snapshot/fingerprint/acceptance and currency-quantum lineage, exposed 58/58/58 independently available metrics and complete totals, and wrote exactly one value-free accepted-read audit row. Real desktop, tablet, and mobile checks passed without horizontal overflow; stopping the API produced the explicit fail-closed unavailable state with no cached, synthetic, or historical 48/10 FIFO substitution. The mode-first URL correction, all 525 tests, focused frontend lint, the production build, authorization, journal-integrity, and automatic-trading-disabled checks passed. No provider or credential access, hosting, VPS work, deployment, broader or realized P&L, or trading is accepted; no commit or push is included. |
| WEB-W08 | IN PROGRESS | Gate 0 verified the accepted current-valuation source and the absence of operational realized-P&L authority. Gate 1 was owner-approved on 2026-09-07. The original Gate 2 implementation was merged on 2026-09-08, and migration 0024 was separately applied after backup and rehearsal with the new tables empty. The first Gate 3 calculation exposed a missing active-history calculator and was not accepted. The local Gate 2 precision correction adds deterministic read-only calculation, strict revision/count/execution reconciliation, value-free unresolved-scope omissions, exact result authorization, and launcher support for a later accepted report authorization. All 546 tests plus 267 subtests, focused checks, frontend lint, and the production build pass. Corrected read-only Gate 3 replay produced exact fingerprint `bd05ac8f87e58b9fdc57792cd19f763ee40a136dcd692e8e0399d19227566063`, 230 admitted allocations, and 57 withheld scopes for the 2026-03-06 through 2026-09-04 coverage window. Reconciliation, deterministic replay, journal integrity, and unchanged-database checks pass. The owner explicitly accepted that exact incomplete bounded result on 2026-09-09 under `ONEJOURNAL-WEB-W08-GATE3-OWNER-ACCEPTANCE-20260909-01`; Gate 3 is complete. Migration 0025 now preserves separate current-result and realized-result acceptance lineage. After successful disposable-copy rehearsal, the separately approved fresh backup and live migration reached 0025 with all 81 compared data-table row counts unchanged, integrity clean, and all five reporting tables empty. Accepted-result persistence, private API/browser verification, release acceptance, commit, and push gates remain open. |
