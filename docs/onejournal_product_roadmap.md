...
| P1-08 | IN PROGRESS | Deliver the bounded Phase 1 current portfolio, account/symbol breakdown, date-filtered P&L history, CSV export, and complete quality states for displayed metrics. | Gates 1 through 3 are complete, including accepted realized fingerprint `bd05ac8f87e58b9fdc57792cd19f763ee40a136dcd692e8e0399d19227566063`, 230 admitted allocations, and 57 withheld scopes across 2026-03-06 through 2026-09-04. Migrations 0024 through 0026 are live with all reporting tables empty. The owner chose private alias `Primary` and approved combined release preparation. The first Gate 4 rehearsal correctly stopped because `DECIMAL(38,13)` would change 16 accepted values; no package was created and the live journal remained unchanged. The local precision correction adds canonical decimal fingerprinting, exact string-to-DuckDB persistence, guarded release preparation, and migration 0026 widening only the still-empty item column to `DECIMAL(38,27)`. A fresh disposable copy reached 0026, preserved 67 non-reporting base-table counts, accepted identical persistence replay, and exactly read back release `ONEJOURNAL-WEB-W08-REPORT-RELEASE-20260909-01`, fingerprint `506a4b49810e4da77f3880818a83425c835eb9cd25d08b1503dd95ed9d6ddb2c`, one `Primary` account, 230 items, 57 omissions, and zero audit rows. The live 0026 migration preserved all non-reporting counts and the empty reporting boundary after a fresh verified backup. A guarded persistence command now defaults to read-only and passed an exact live dry-run against the prepared package without changing the database. The value-free private authorization remains inactive. Exact release persistence, API/browser verification, final owner acceptance, and the next Git gate remain open. Advanced analytics remain later. |
...
| WEB-W08 | IN PROGRESS | Gates 1 through 3 are complete for accepted realized fingerprint `bd05ac8f87e58b9fdc57792cd19f763ee40a136dcd692e8e0399d19227566063`, 230 admitted allocations, and 57 withheld scopes. Migrations 0024 through 0026 are live empty. The owner chose alias `Primary` and approved combined release preparation. Gate 4 rehearsal exposed and stopped a `DECIMAL(38,13)` precision loss affecting 16 values. The local correction adds canonical decimal persistence, a guarded preparation/rehearsal operator, and empty-table-only migration 0026 using `DECIMAL(38,27)`. A fresh disposable copy reached 0026, preserved 67 non-reporting base-table counts, passed identical replay and exact read-back, and produced release fingerprint `506a4b49810e4da77f3880818a83425c835eb9cd25d08b1503dd95ed9d6ddb2c` with one `Primary` account, 230 items, 57 omissions, and no audit rows. The separately approved live 0026 migration preserved the empty reporting boundary and all non-reporting counts after a fresh verified backup. The guarded persistence command defaults to read-only and its exact live dry-run rebuilt the prepared release without changing the database. The private authorization remains inactive; exact release persistence, API/browser verification, final owner acceptance, and the next Git gate remain open. |
