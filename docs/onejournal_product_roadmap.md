...
| PNL-02-T14 | BLOCKED | Execute the approved broader conformance matrix across Schwab equity and listed-option shapes, required session states, entitlement/delay states, stale/future/crossed/missing evidence, exact identity, and provider-neutral non-fallback behavior. | Synthetic conformance covers equity/listed-option mapping, all configured freshness and session states, exact identity/source binding, outage/expiry, atomic replay/read-back, and cross-provider fallback rejection. On 2026-08-28 the owner attested, created the append-only acknowledgement, approved capture `PNL-02-T14-SCHWAB-20260828-04`, and approved its checksum transfer. The v5 runner (`4c092ee5cd0c57dfa71d50b8d54310139a7e45bf9b8a969c40337a6a4fc0f6b0`) completed exactly five GETs with zero refresh/account/order/database actions. The nine-file private bundle retains manifest SHA-256 `0a76515d4966e5222435ffc63067b1fc4de6ec7e95539a90264a2ad950482bc1` under `0700`/`0600`. Both official quotes report real-time entitlement, omit market session, and pass the credential-free stock/option adapter. `schwab-market-hours-json-v1` accepts the exact normal, closed-sentinel, and shortened-session payloads. The owner-approved 2026-08-29 correction adds provider-neutral `closed_unspecified`, offset-validated `EQ`/`EQO`/`IND` to `America/New_York` mappings, normal-versus-shortened classification, exact provider/connection/asset/date binding, expiry checks, and combined-manifest lineage through `schwab-market-hours-resolver-v1`. Focused tests and read-only private-byte validation pass. The actual quotes still fail closed because the bundle has no 2026-08-28 schedule. T14 now requires one separately approved same-date quote-and-schedule capture and acceptance review; no journal write, migration, provider activation, new provider call, commit, or push is authorized or claimed. Live IBKR and Moomoo remain later rollouts. |
