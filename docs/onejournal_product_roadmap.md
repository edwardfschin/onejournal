...
| PNL-03 | IN PROGRESS | Implement current positions, cost basis, market value, and unrealized P&L. | The owner accepted ADR-0019 on 2026-08-31. PNL-03A through J establish typed instrument identity, complete-account position reconciliation, valuation-mark selection, temporary-DuckDB persistence, portfolio aggregation, the bounded position-evidence bridge, owner-private source capture, and real-shape adapter correction. PNL-03K transferred the 53-position bundle and proved that none of the seven identities in five accepted historical PNL-01 scopes overlaps a current position. ADR-0021 and PNL-03L add paired bounded lifecycle intake; PNL-03M proves its first 30-day real Schwab window and source-bound currency correction. PNL-03N adds deterministic cross-window assembly; PNL-03O corrects exact source-window membership; PNL-03P extends accepted real coverage through a third contiguous window while preserving repeated non-intersecting OCO evidence; PNL-03Q extends it through a fourth contiguous window; and PNL-03R extends it through a fifth contiguous window. The five-window replay proves bounded fill-flat starts for 46 positions, requires earlier history for four, and keeps three missing-order-ID current positions review-required. ADR-0022 and PNL-03S freeze that 46/4/3 baseline and permit a bounded fail-closed route: the eligible 46 may advance while the other seven remain visible, financially unavailable, and excluded from complete totals. PNL-03T now proves the durable private account/instrument binding, eligible FIFO, and exact broker reconciliation gates for the 46 while retaining all seven unavailable positions. Current per-import `normalized_positions` remain prototype-only. Remaining gates are accepted valuation-mark evidence, enforced visibility/exclusion for the seven unavailable positions, versioned API/presentation wiring, production migration approval, and owner financial acceptance. Earlier history is optional additive evidence and no longer blocks this bounded route. |
