...
| [ADR-0017](decisions/0017-open-source-production-web-foundation.md) | Accepted | Use an open-source React/Vite/FastAPI production foundation with a portable service topology and visible vertical delivery checkpoints |
| [ADR-0018](decisions/0018-phase-1-private-owner-release.md) | Accepted | Complete Phase 1 as a finite, secure, private single-owner Schwab release without requiring later brokers, continuous connector ownership, advanced analytics, attachments, or trading automation |
| [ADR-0019](decisions/0019-canonical-position-reconciliation-and-valuation-mark-authority.md) | Accepted | Use cumulative FIFO lots reconciled to independent broker positions and provider-bound liquidation-side marks for authoritative current valuation |
...
| [ADR-0024](decisions/0024-versioned-phase1-schwab-evidence-assembly.md) | Accepted | Import one exact opaque Schwab account as an immutable, replay-safe eight-family evidence assembly without rewriting legacy or PNL-03 state |
| [ADR-0025](decisions/0025-schwab-lifecycle-complete-journal-state.md) | Accepted | Preserve Schwab terminal lifecycle events in assembly v2 and reconcile historical journal state without promoting financial authority |
