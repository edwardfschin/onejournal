...
class LocalOwnerReportingApiTests(LocalOwnerPortfolioApiTests):
    def setUp(self) -> None:
        ...
        base_release = ReportingRelease(
            ...
            current_owner_acceptance_uid="current-owner-acceptance:synthetic",
            current_owner_accepted_at_utc=self.evaluated_at,
            realized_calculation_run_id="realized-run-1",
            realized_result_fingerprint="c" * 64,
            realized_owner_acceptance_uid="realized-owner-acceptance:synthetic",
            realized_owner_accepted_at_utc=self.evaluated_at,
