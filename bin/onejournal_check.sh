...
check_path "docs/operator_import_runbook.md" "$PROJECT_DIR/docs/operator_import_runbook.md"
check_file_contains "operator import runbook title" "$PROJECT_DIR/docs/operator_import_runbook.md" "OneJournal Operator Import Runbook"
check_file_contains "operator import safe sequence" "$PROJECT_DIR/docs/operator_import_runbook.md" "Safe import sequence"
check_file_contains "operator import normalized validation" "$PROJECT_DIR/docs/operator_import_runbook.md" "check_normalized_fills_contract.py --asof"
check_file_contains "operator import audit check" "$PROJECT_DIR/docs/operator_import_runbook.md" "check_import_run_audit.py --db"
check_file_contains "operator import no raw dashboard" "$PROJECT_DIR/docs/operator_import_runbook.md" "Do not use raw broker CSV directly for dashboard payloads"
check_file_contains "operator import no manual review csv truth" "$PROJECT_DIR/docs/operator_import_runbook.md" "Do not treat manual_reviews.csv as live review source of truth"
check_file_contains "operator quickstart phase i5" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase I5 operator import runbook"
check_path "docs/schwab_execution_boundary_contract.md" "$PROJECT_DIR/docs/schwab_execution_boundary_contract.md"
check_file_contains "schwab boundary current readonly" "$PROJECT_DIR/docs/schwab_execution_boundary_contract.md" "Schwab journal ingestion is read-only"
check_file_contains "schwab boundary order intent" "$PROJECT_DIR/docs/schwab_execution_boundary_contract.md" "Future auto-trading must use order intents"
check_file_contains "schwab boundary risk gate" "$PROJECT_DIR/docs/schwab_execution_boundary_contract.md" "Every future broker write action must pass a risk gate first"
check_file_contains "schwab boundary no direct strategy order" "$PROJECT_DIR/docs/schwab_execution_boundary_contract.md" "A strategy must not call Schwab order-place directly"
check_file_contains "schwab boundary no journal order writes" "$PROJECT_DIR/docs/schwab_execution_boundary_contract.md" "Journal adapter modules must not import order-place, order-cancel, order-replace, or order-modify functions"
check_file_contains "schwab boundary fill feedback" "$PROJECT_DIR/docs/schwab_execution_boundary_contract.md" "Every future broker fill must return to OneJournal through the normalized_fills contract"
check_file_contains "schwab boundary streaming not truth" "$PROJECT_DIR/docs/schwab_execution_boundary_contract.md" "Schwab streaming is not journal source of truth"
check_file_contains "operator quickstart phase j0" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase J0 Schwab execution boundary"
check_path "docs/schwab_adapter_readiness_audit.md" "$PROJECT_DIR/docs/schwab_adapter_readiness_audit.md"
check_file_contains "schwab readiness title" "$PROJECT_DIR/docs/schwab_adapter_readiness_audit.md" "OneJournal Schwab Adapter Readiness Audit"
check_file_contains "schwab readiness real sample" "$PROJECT_DIR/docs/schwab_adapter_readiness_audit.md" "Do not build a Schwab adapter until at least one real Schwab export sample has been reviewed"
check_file_contains "schwab readiness raw path" "$PROJECT_DIR/docs/schwab_adapter_readiness_audit.md" "data/raw/schwab"
check_file_contains "schwab readiness normalized path" "$PROJECT_DIR/docs/schwab_adapter_readiness_audit.md" "data/normalized/fills"
check_file_contains "schwab readiness reserved package" "$PROJECT_DIR/docs/schwab_adapter_readiness_audit.md" "src/onejournal/brokers/schwab"
check_file_contains "schwab readiness reserved script" "$PROJECT_DIR/docs/schwab_adapter_readiness_audit.md" "convert_schwab_export_to_normalized_fills.py"
check_file_contains "schwab readiness no rest first" "$PROJECT_DIR/docs/schwab_adapter_readiness_audit.md" "It should not call Schwab REST APIs"
check_file_contains "schwab readiness no orders" "$PROJECT_DIR/docs/schwab_adapter_readiness_audit.md" "It should not place, cancel, replace, or modify orders"
check_file_contains "schwab readiness future execution" "$PROJECT_DIR/docs/schwab_adapter_readiness_audit.md" "Future Schwab order operations belong in the execution plane"
check_file_contains "operator quickstart phase j1" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase J1 Schwab adapter readiness audit"
check_path "docs/schwab_legacy_normalizer_findings.md" "$PROJECT_DIR/docs/schwab_legacy_normalizer_findings.md"
check_file_contains "schwab legacy findings title" "$PROJECT_DIR/docs/schwab_legacy_normalizer_findings.md" "OneJournal Schwab Legacy Normalizer Findings"
check_file_contains "schwab legacy transfer items" "$PROJECT_DIR/docs/schwab_legacy_normalizer_findings.md" "Security transferItems represent fill legs"
check_file_contains "schwab legacy currency ignored" "$PROJECT_DIR/docs/schwab_legacy_normalizer_findings.md" "CURRENCY transferItems should not become fill legs"
check_file_contains "schwab legacy price inference" "$PROJECT_DIR/docs/schwab_legacy_normalizer_findings.md" "infer price from absolute cost divided by absolute quantity times multiplier"
check_file_contains "schwab legacy output normalized" "$PROJECT_DIR/docs/schwab_legacy_normalizer_findings.md" "The Schwab adapter must output the canonical OneJournal normalized fills contract"
check_file_contains "schwab legacy shared normalizer" "$PROJECT_DIR/docs/schwab_legacy_normalizer_findings.md" "Schwab CSV import and Schwab REST transaction import should share the same normalizer core"
check_file_contains "schwab legacy nonempty sample needed" "$PROJECT_DIR/docs/schwab_legacy_normalizer_findings.md" "non-empty Schwab transaction JSON or CSV sample"
check_file_contains "operator quickstart phase j2" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase J2 Schwab legacy normalizer findings"
check_path "docs/schwab_orders_json_schema_contract.md" "$PROJECT_DIR/docs/schwab_orders_json_schema_contract.md"
check_file_contains "schwab orders schema title" "$PROJECT_DIR/docs/schwab_orders_json_schema_contract.md" "OneJournal Schwab Orders JSON Schema Contract"
check_file_contains "schwab orders schema fill truth" "$PROJECT_DIR/docs/schwab_orders_json_schema_contract.md" "executionType is FILL"
check_file_contains "schwab orders schema no status alone" "$PROJECT_DIR/docs/schwab_orders_json_schema_contract.md" "Do not use order status alone as the fill source of truth"
check_file_contains "schwab orders schema leg match" "$PROJECT_DIR/docs/schwab_orders_json_schema_contract.md" "Each executionLeg must be matched to orderLegCollection by legId"
check_file_contains "schwab orders schema source fill id" "$PROJECT_DIR/docs/schwab_orders_json_schema_contract.md" "source_fill_id must be unique and should use orderId, activityId, and legId"
check_file_contains "schwab orders schema oco" "$PROJECT_DIR/docs/schwab_orders_json_schema_contract.md" "OCO parent orders must be flattened into child orders"
check_file_contains "schwab orders schema partial fills" "$PROJECT_DIR/docs/schwab_orders_json_schema_contract.md" "Do not aggregate partial fills inside the adapter"
check_file_contains "schwab orders schema fee limitation" "$PROJECT_DIR/docs/schwab_orders_json_schema_contract.md" "Fee enrichment should come later from Schwab transactions transferItems JSON"
check_file_contains "operator quickstart phase j3" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase J3 Schwab orders JSON schema contract"
check_path "src/onejournal/brokers/schwab/orders_json.py" "$PROJECT_DIR/src/onejournal/brokers/schwab/orders_json.py"
check_path "scripts/journal/convert_schwab_orders_json_to_normalized_fills.py" "$PROJECT_DIR/scripts/journal/convert_schwab_orders_json_to_normalized_fills.py"
check_path "docs/schwab_orders_json_adapter.md" "$PROJECT_DIR/docs/schwab_orders_json_adapter.md"
check_path "docs/examples/schwab_orders_json/orders_sample.json" "$PROJECT_DIR/docs/examples/schwab_orders_json/orders_sample.json"
check_file_contains "schwab orders adapter fill extraction" "$PROJECT_DIR/src/onejournal/brokers/schwab/orders_json.py" "executionType"
check_file_contains "schwab orders adapter no aggregation" "$PROJECT_DIR/src/onejournal/brokers/schwab/orders_json.py" "source_fill_id = f"
check_file_contains "schwab orders adapter cli readonly" "$PROJECT_DIR/scripts/journal/convert_schwab_orders_json_to_normalized_fills.py" "ORDER API : disabled"
check_file_contains "schwab orders adapter docs readonly" "$PROJECT_DIR/docs/schwab_orders_json_adapter.md" "It is read-only"
check_file_contains "operator quickstart phase j4" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase J4 Schwab orders JSON adapter"
check_path "scripts/journal/check_odfs_continuity.py" "$PROJECT_DIR/scripts/journal/check_odfs_continuity.py"
check_path "docs/odfs_continuous_guard.md" "$PROJECT_DIR/docs/odfs_continuous_guard.md"
check_file_contains "odfs continuity guard title" "$PROJECT_DIR/docs/odfs_continuous_guard.md" "OneJournal ODFS Continuous Guard"
check_file_contains "odfs continuity guard generated fills" "$PROJECT_DIR/docs/odfs_continuous_guard.md" "Generated normalized fills CSV files are operational artifacts"
check_file_contains "odfs continuity guard raw schwab" "$PROJECT_DIR/docs/odfs_continuous_guard.md" "Raw broker files are private evidence files"
check_file_contains "operator quickstart phase k1" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase K1 ODFS continuous guard"
check_path "docs/schwab_transactions_json_contract.md" "$PROJECT_DIR/docs/schwab_transactions_json_contract.md"
check_file_contains "schwab transactions contract title" "$PROJECT_DIR/docs/schwab_transactions_json_contract.md" "OneJournal Schwab Transactions JSON Contract"
check_file_contains "schwab transactions fee evidence" "$PROJECT_DIR/docs/schwab_transactions_json_contract.md" "CURRENCY transferItems are fee or cash evidence"
check_file_contains "schwab transactions security item" "$PROJECT_DIR/docs/schwab_transactions_json_contract.md" "Security transferItems are fill-leg candidates"
check_file_contains "schwab transactions trade valid" "$PROJECT_DIR/docs/schwab_transactions_json_contract.md" "Only type TRADE and status VALID records"
check_file_contains "schwab transactions no duckdb" "$PROJECT_DIR/docs/schwab_transactions_json_contract.md" "Do not write directly to DuckDB"
check_file_contains "operator quickstart phase l1" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase L1 Schwab transactions JSON contract"
check_path "src/onejournal/brokers/schwab/transactions_json.py" "$PROJECT_DIR/src/onejournal/brokers/schwab/transactions_json.py"
check_path "scripts/journal/convert_schwab_transactions_json_to_normalized_fills.py" "$PROJECT_DIR/scripts/journal/convert_schwab_transactions_json_to_normalized_fills.py"
check_path "docs/schwab_transactions_json_adapter.md" "$PROJECT_DIR/docs/schwab_transactions_json_adapter.md"
check_file_contains "schwab transactions adapter trade valid" "$PROJECT_DIR/src/onejournal/brokers/schwab/transactions_json.py" "TRADE"
check_file_contains "schwab transactions adapter currency fees" "$PROJECT_DIR/docs/schwab_transactions_json_adapter.md" "CURRENCY transferItems are fee and commission evidence"
check_file_contains "operator quickstart phase l2" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase L2 Schwab transactions JSON adapter"
check_path "scripts/journal/reconcile_schwab_orders_transactions.py" "$PROJECT_DIR/scripts/journal/reconcile_schwab_orders_transactions.py"
check_path "docs/schwab_orders_transactions_reconciliation.md" "$PROJECT_DIR/docs/schwab_orders_transactions_reconciliation.md"
check_file_contains "schwab reconciliation title" "$PROJECT_DIR/docs/schwab_orders_transactions_reconciliation.md" "OneJournal Schwab Orders vs Transactions Reconciliation"
check_file_contains "schwab reconciliation readonly" "$PROJECT_DIR/scripts/journal/reconcile_schwab_orders_transactions.py" "DUCKDB WRITE : disabled"
check_file_contains "operator quickstart phase l3" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase L3 Schwab reconciliation check"
check_path "scripts/journal/run_schwab_daily_reconciliation.py" "$PROJECT_DIR/scripts/journal/run_schwab_daily_reconciliation.py"
check_path "docs/schwab_daily_reconciliation_operator.md" "$PROJECT_DIR/docs/schwab_daily_reconciliation_operator.md"
check_file_contains "schwab daily operator safety" "$PROJECT_DIR/docs/schwab_daily_reconciliation_operator.md" "This command does not write DuckDB"
check_file_contains "schwab daily operator cleanup" "$PROJECT_DIR/docs/schwab_daily_reconciliation_operator.md" "Removes generated normalized CSVs unless --keep-files is provided"
check_file_contains "operator quickstart phase m1" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase M1 Schwab daily reconciliation operator"
check_path "scripts/journal/run_schwab_daily_import.py" "$PROJECT_DIR/scripts/journal/run_schwab_daily_import.py"
check_path "docs/schwab_daily_import_operator.md" "$PROJECT_DIR/docs/schwab_daily_import_operator.md"
check_file_contains "schwab daily import explicit flag" "$PROJECT_DIR/docs/schwab_daily_import_operator.md" "only when --import-db is present"
check_file_contains "schwab daily import strict reconcile" "$PROJECT_DIR/docs/schwab_daily_import_operator.md" "Strictly reconcile orders and transactions normalized fills"
check_file_contains "operator quickstart phase m2" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase M2 Schwab guarded daily import operator"
check_path "scripts/journal/check_schwab_daily_import_idempotency.py" "$PROJECT_DIR/scripts/journal/check_schwab_daily_import_idempotency.py"
check_path "docs/schwab_daily_import_idempotency.md" "$PROJECT_DIR/docs/schwab_daily_import_idempotency.md"
check_file_contains "schwab idempotency temp db" "$PROJECT_DIR/docs/schwab_daily_import_idempotency.md" "temporary DB"
check_file_contains "schwab idempotency no duplicate" "$PROJECT_DIR/docs/schwab_daily_import_idempotency.md" "does not duplicate fills"
check_file_contains "operator quickstart phase m3" "$PROJECT_DIR/docs/operator_quickstart.md" "Phase M3 Schwab import idempotency guard"
check_path "scripts/journal/find_and_run_schwab_daily_import.py" "$PROJECT_DIR/scripts/journal/find_and_run_schwab_daily_import.py"
check_path "docs/schwab_auto_discovery_import_operator.md" "$PROJECT_DIR/docs/schwab_auto_discovery_import_operator.md"
check_file_contains "schwab autodiscovery file pattern" "$PROJECT_DIR/docs/schwab_auto_discovery_import_operator.md" "orders files using"
check_file_contains "schwab autodiscovery import flag" "$PROJECT_DIR/docs/schwab_auto_discovery_import_operator.md" "DuckDB import still requires explicit --import-db"
...
check_file_contains "schwab no fill noop" "$PROJECT_DIR/scripts/journal/run_schwab_daily_import.py" "NO FILL RESULT"
check_file_contains "operator quickstart no fill noop" "$PROJECT_DIR/docs/operator_quickstart.md" "NO FILL RESULT means both Schwab orders and transactions produced zero normalized fill rows"
...
check_file_contains "schwab autodiscovery phase m6" "$PROJECT_DIR/docs/schwab_auto_discovery_import_operator.md" "Phase M6 Schwab final daily operator workflow"
check_file_contains "schwab daily import phase m6" "$PROJECT_DIR/docs/schwab_daily_import_operator.md" "Phase M6 Schwab final daily operator workflow"
check_file_contains "script inventory phase m6" "$PROJECT_DIR/docs/script_inventory.md" "Phase M6 Schwab Final Operator Runbook"
check_file_contains "operator m6 import flag" "$PROJECT_DIR/docs/operator_quickstart.md" "DuckDB import requires explicit --import-db"
check_file_contains "operator m6 canonical source" "$PROJECT_DIR/docs/operator_quickstart.md" "Transactions-normalized fills are the current DuckDB import source"
check_file_contains "script inventory schwab autodiscovery" "$PROJECT_DIR/docs/script_inventory.md" "find_and_run_schwab_daily_import.py"
check_file_contains "script inventory schwab idempotency" "$PROJECT_DIR/docs/script_inventory.md" "check_schwab_daily_import_idempotency.py"
check_file_contains "script inventory schwab daily import" "$PROJECT_DIR/docs/script_inventory.md" "run_schwab_daily_import.py"
check_file_contains "script inventory schwab daily operator" "$PROJECT_DIR/docs/script_inventory.md" "run_schwab_daily_reconciliation.py"
check_file_contains "script inventory schwab reconciliation" "$PROJECT_DIR/docs/script_inventory.md" "reconcile_schwab_orders_transactions.py"
check_file_contains "script inventory schwab transactions adapter" "$PROJECT_DIR/docs/script_inventory.md" "convert_schwab_transactions_json_to_normalized_fills.py"
check_file_contains "script inventory schwab transactions contract" "$PROJECT_DIR/docs/script_inventory.md" "schwab_transactions_json_contract.md"
check_file_contains "script inventory odfs continuity" "$PROJECT_DIR/docs/script_inventory.md" "check_odfs_continuity.py"
echo "===== ODFS Continuity Guard ====="
"$PY" "$PROJECT_DIR/scripts/journal/check_odfs_continuity.py" || fail_count=$((fail_count+1))
check_file_contains "script inventory schwab orders adapter" "$PROJECT_DIR/docs/script_inventory.md" "convert_schwab_orders_json_to_normalized_fills.py"
check_file_contains "script inventory schwab orders schema" "$PROJECT_DIR/docs/script_inventory.md" "schwab_orders_json_schema_contract.md"
check_file_contains "script inventory schwab legacy findings" "$PROJECT_DIR/docs/script_inventory.md" "schwab_legacy_normalizer_findings.md"
check_file_contains "script inventory schwab readiness" "$PROJECT_DIR/docs/script_inventory.md" "schwab_adapter_readiness_audit.md"
check_file_contains "script inventory schwab boundary" "$PROJECT_DIR/docs/script_inventory.md" "schwab_execution_boundary_contract.md"
check_file_contains "script inventory operator import runbook" "$PROJECT_DIR/docs/script_inventory.md" "operator_import_runbook.md"
